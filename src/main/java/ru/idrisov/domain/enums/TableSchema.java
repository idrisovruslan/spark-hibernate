...
public enum TableSchema {
    ...
    CUSTOM_FIN_FSO_STG(Schema.CUSTOM_FIN_FSO_STG),
    CUSTOM_FIN_FSO_TMD_STG(Schema.CUSTOM_FIN_FSO_TMD_STG),
    ...
    CUSTOM_FIN_FSO_DMDS(Schema.CUSTOM_FIN_FSO_DMDS),
    ...
    public static class Schema {
        public static final String CUSTOM_FIN_FSO_STG = "custom_fin_fso_stg";
        public static final String CUSTOM_FIN_FSO_TMD_STG = "custom_fin_fso_tmd_stg";
        public static final String CUSTOM_FIN_FSO_DMDS = "custom_fin_fso_dmds";
    }
